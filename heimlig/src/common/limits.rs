...
pub const MAX_RANDOM_SIZE: usize = 1500; // Ethernet MTU

/// Maximum plaintext length for symmetric encryption.
pub const MAX_PLAINTEXT_SIZE: usize = 1500; // Ethernet MTU

/// Maximum ciphertext length for symmetric encryption.
pub const MAX_CIPHERTEXT_SIZE: usize = 1500; // Ethernet MTU
